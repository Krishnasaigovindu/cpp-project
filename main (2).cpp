//vignan's medical Store Management System c++ project
#include <iostream>
#include <stdlib.h>
#include <string>
#include <cctype>
...
struct node // constract node
{
	...
	string medicineName[100] = {"Probiotics", "Vitamin C(500mg)", "Acid Free C(500mg)", "Women'S Multivate", "Marino Tablet", 
	"Maxi Cal Tablet", "Amino Zinc Tablet", "Burnex", "Fabuloss 5", "Royal Propollen", "Cetrizine", "Monocef (250mg)",
	"Dolo 650", "Paracetamol", "Cureveda", "Dexona", "Savlon", "Cotton", "Nicip", "Benadryl", "Flexon", "Vicks", "Volini", "Crepe bandage"};
	
	double Medicine[100] = {32.00, 60.00, 89.00, 140.00, 132.00, 95.00, 57.00, 49.00, 73.00, 56.00, 20.00,
	240.00, 69.00, 500.00, 945.00, 50.00, 79.00, 23.00, 12.00, 110.00, 4.00, 59.00, 130.00, 410.00};
	double total;
...
int main() // Main function
{
	...
	{
		cout << "----------------------------------------------------\n";
		cout << "------| Vignan's Medical Store Management System |------- \n";
		//cout << "\t\t  ==================================================\n\n";
		cout << "----------------------------------------------------\n";
...
void medicineType::order_list() // Function to display receipt
{
	...
	while (temp != NULL && !found)
	{
		...
		if (found) // print the receipt
		{
			...
			temp->total = temp->amount[0] + temp->amount[1] + temp->amount[2] + temp->amount[3] + temp->amount[4] + 
			temp->amount[5] + temp->amount[6] + temp->amount[7] + temp->amount[8] + temp->amount[9];
